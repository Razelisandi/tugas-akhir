...
<body>
    ...
    <a href="{{ route('google.login') }}"
        ...
        <svg class="w-5 h-5 mr-2" viewBox="0 0 533.5 544.3"><path fill="#fff" d="M533.5 278.4c0-17.7-1.6-35.1-4.8-52H272v98.5h146.9c-6.3 34.2-25.3 63.2-53.8 82.4v68h86.7c50.7-46.8 81.7-115.7 81.7-197z"/><path fill="#fff" d="M272 544.3c72.8 0 133.9-24.1 178.5-65.5l-86.7-68c-24.1 16.2-54.8 25.7-91.8 25.7-70.6 0-130.4-47.6-151.8-111.6h-90.2v69.8C80.5 486.4 169.6 544.3 272 544.3z"/><path fill="#fff" d="M120.2 324.9c-7.7-22.8-7.7-47.4 0-70.2v-69.8H30C10.8 220.7 0 245.3 0 272s10.8 51.3 30.2 86.9l90-69.8z"/><path fill="#fff" d="M272 107.6c39.6 0 75.3 13.6 103.2 40.5l77.4-77.4C407.1 24.1 345.9 0 272 0 169.6 0 80.5 57.9 30.2 145.1l90 69.8c21.4-64 81.2-111.6 151.8-111.6z"/></svg>
        Sign in with Google
    </a>
</div>

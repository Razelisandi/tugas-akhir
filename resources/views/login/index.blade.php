    ...
    <div class="relative flex items-center justify-center min-h-screen bg-gray-100 px-6 py-12">
        ...
        <div class="z-10 w-full max-w-sm">
            ...
            <form class="mt-10 space-y-6" action="#" method="POST">
                ...
                <div>
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-sm font-semibold text-blue-300 hover:text-blue-400">Forgot
                            password?</a>
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-4">
                        <a href="#"
                            class="flex items-center justify-center w-full px-4 py-2 text-sm font-semibold text-white bg-gray-400 rounded-md hover:bg-gray-500">
            ...
            <p class="mt-10 text-center text-sm text-white">
                Not a member?
                <a href="{{ route('register') }}" class="font-semibold text-blue-300 hover:text-blue-400">Register</a>
            </p>
        </div>
    </div>

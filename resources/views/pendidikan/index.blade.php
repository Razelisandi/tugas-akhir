...
<body>
    ...
    <div class="relative z-10 flex flex-col mt-40 -h-screen text-white px-4 max-w-310 mx-auto ">
        ...
        <form class="mt-10 space-y-6 w-110" action="/predict_edu" method="POST">
            <div>
                <label for="minat" class="block text-sm font-medium text-white">Bidang Studi Yang Diminati</label>
                <input type="text" name="minat" id="minat" required
            ...
            <div>
                <div class="flex items-center justify-between">
                    <label for="nilai-akademik" class="block text-sm font-medium text-white">Nilai Akademik (Rata-rata)</label>
                </div>
